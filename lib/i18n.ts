...
const translations: Record<Language, Record<string, string>> = {
  tr: {
    ...
    "referrals.clinicRates": "Klinik İndirim Oranları",
    "referrals.inviterDiscount": "Davet eden için",
    "referrals.invitedDiscount": "Davet edilen için",
  ...
  en: {
    ...
    "referrals.clinicRates": "Clinic Discount Rates",
    "referrals.inviterDiscount": "For inviter",
    "referrals.invitedDiscount": "For invited",
