...
import {
  ...
  Keyboard, type KeyboardEvent, StatusBar,
} from 'react-native';
...
export default function QuoteRequestScreen() {
  ...
  /** Y within scroll content — from onLayout (avoids measureLayout + findNodeHandle on Fabric). */
  const descriptionScrollYRef = useRef(0);
  const insets = useSafeAreaInsets();
  const [keyboardHeight, setKeyboardHeight] = useState(0);

  /** Android IME offset (status/navigation varies by device). */
        ...
        >
          <ScrollView
            ...
            contentContainerStyle={[
              styles.formScroll,
              {
                /** Extra space so description + footer clear IME on both platforms */
          ...
          >
            ...
            <View
              ...
              onLayout={(e) => {
                descriptionScrollYRef.current = e.nativeEvent.layout.y;
              }}
            >
              ...
              <TextInput
                ...
                onFocus={() => {
                  ...
                  setTimeout(() => {
                    const y = descriptionScrollYRef.current;
                    formScrollRef.current?.scrollTo({
                      y: Math.max(0, (y > 0 ? y : 160) - 16),
                      animated: true,
                    });
                  }, delay);
                }}
          ...
          {/* Footer */}
          <View style={[styles.footer, keyboardHeight > 0 && styles.footerKeyboardUp]}>
            <TouchableOpacity
