  ...
  const handleRegister = async () => {
    ...
    try {
      ...
      if (data.ok) {
        Alert.alert(
          "Başarılı",
          "Doktor kaydınız alındı. Admin onayı bekleniyor.",
          [
            {
              text: "Tamam",
              onPress: () => {
    ...
    <View style={{ flex: 1, padding: 20, justifyContent: "center" }}>
      ...
      >
        {loading ? (
          ...
          <Text style={{ color: "white", fontWeight: "bold" }}>Doktor Olarak Kayıt Ol</Text>
        )}
      </TouchableOpacity>
      ...
      >
        <Text style={{ color: "#2563eb" }}>Hasta mı kayıt olacaksınız?</Text>
      </TouchableOpacity>
    </View>
  );
}
