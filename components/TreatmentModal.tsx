      ...
      <View style={styles.sheet}>
        <View style={styles.header}>
          <View>
            ...
            <Text style={styles.subtitle}>{jaw === "upper" ? "Upper" : "Lower"}</Text>
          </View>
            ...
            procedures.map((p, idx) => (
              <View key={`${p.type}-${idx}`} style={styles.card}>
                <View style={styles.row}>
                  ...
                  <Text style={styles.status}>{statusLabel(p.status)}</Text>
                </View>

                {p.date ? <Text style={styles.meta}>Date: {p.date}</Text> : null}

                {p.note ? <Text style={styles.meta}>Note: {p.note}</Text> : null}
        ...
        <Pressable style={styles.addButton} onPress={handleAddTreatment}>
